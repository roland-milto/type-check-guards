...
`isNumber` sjekker om en verdi er et endelig, ikke-`NaN` tall.

### Brukstilfelle

Valider numerisk input fra upålitelige kilder (skjemaer, query-parametere, JSON-payloads) før beregninger, lagring eller
områdesjekker, slik at kun endelige tall slipper gjennom (`true`) og alt annet returnerer `false`.
...
<small>Filen ble generert 30 January 2026 at 13:10:28 (UTC) ved bruk av *
