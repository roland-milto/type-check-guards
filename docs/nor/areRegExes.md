...
Valider at et konfigurasjonsalternativ (f.eks. en liste med tillat-/nekt-mønstre) er en ikke-tom matrise med regulære
uttrykk før du bruker det til matching.

> **Merknad for TypeScript-brukere:**
>
> Bruk `areRegExes` for å snevre inn `unknown` til `RegExp[]` før du itererer eller setter sammen mønstre.
...
if (areRegExes(patterns)) {
  // patterns ke array ya RegExp mo
...
<small>Filen ble generert 30 January 2026 at 23:20:31 (UTC) ved bruk av *
