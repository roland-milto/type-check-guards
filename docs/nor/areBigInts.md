...
- Avviser ikke-arrays og tomme arrays med hensikt (via `isFilledArray`), og forhindrer utilsiktet godkjenning av
  ugyldige inndata.
- Rask avbryt: returnerer `false` så snart et element som ikke er `bigint` blir funnet.
