...
det finnes en match og `false` ellers.
...
>
> Bruk `isOneOfType` når du vil ha en runtime-sjekk som verifiserer at en verdi samsvarer med en av flere tillatte
> typer; den returnerer `true` hvis minst én type matcher, ellers `false`.
...
console.log(isOneOfType("hello", ["number", "boolean"])); // usant
...
<small>Filen ble generert 6 February 2026 at 13:53:38 (UTC) ved bruk av *
