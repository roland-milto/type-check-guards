...
`arePromises` avgjør om alle elementer i en array er `Promise`-instanser.
...
- Returnerer `false` for tomme arrayer, noe som forhindrer tvetydige resultater for tomme inndata.
...
if (arePromises(values)) {
  // values ke array ya di-instance tsa Promise ka nako ya runtime
...
<small>Filen ble generert 30 January 2026 at 23:49:21 (UTC) ved bruk av *
