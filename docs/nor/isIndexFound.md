...
> ugyldige verdier) kan indikere «ikke funnet». Når den returnerer `true`, er verdien et tall og trygg å bruke som en
> array-/strengindeks.

### Fordeler

- Gir en enkel typevakt for å oppdage om en indeks ble funnet ved å sjekke etter et ikke-negativt heltall.
- Returnerer `true` kun for gyldige indekslignende verdier (heltall `>= 0`), og avviser negative verdier, ikke-heltall
  og ikke-tall.
...
<small>Filen ble generert 31 January 2026 at 00:47:14 (UTC) ved bruk av *
