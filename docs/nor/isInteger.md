...
Valider upålitelig input (f.eks. spørringsparametere, JSON-nyttelaster, miljøvariabler) før du bruker det som et heltall
for arrayindekser, paginering, tellere eller database-ID-er.
...
- Avviser ikke-heltall og usikre heltall, noe som gjør den egnet for ID-er, tellere og indeksering i arrayer.
...
<small>Filen ble generert 31 January 2026 at 00:50:56 (UTC) ved bruk av *
