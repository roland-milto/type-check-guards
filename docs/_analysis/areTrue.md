...
|:----------|:----------|:------------------------------------------|
| array     | boolean[] | The array to check for all `true` values. |

Expected return type: `boolean`

## Specific tests

| Parameter <br> `array`       | Function <br> `areTrue` | Description                                                                    |
|:-----------------------------|:------------------------|:-------------------------------------------------------------------------------|
| `[true]`                     | true                    | Single true                                                                    |
| `[true,true,true]`           | true                    | All true values                                                                |
| `[true,true,true,true,true]` | true                    | Many true values                                                               |
| `[]`                         | false                   | Empty array (not filled)                                                       |
| `[true,false,true]`          | false                   | Contains false                                                                 |
| `[false]`                    | false                   | Single false                                                                   |
| `[true,1,true]`              | false                   | Contains truthy number. `boolean` expected for *array[1]*, but `integer` given |
| `[true,"true",true]`         | false                   | Contains string 'true'. `boolean` expected for *array[1]*, but `string` given  |
| `[true,true,true]`           | true                    | Contains boxed Boolean object                                                  |
| `[true,null,true]`           | false                   | Contains null. `boolean` expected for *array[1]*, but `null` given             |
| `[true,null,true]`           | false                   | Contains undefined. `boolean` expected for *array[1]*, but `undefined` given   |
| `[true,{},true]`             | false                   | Contains object. `boolean` expected for *array[1]*, but `object` given         |
| `[true,[],true]`             | false                   | Contains array. `boolean` expected for *array[1]*, but `array` given           |
...
| Date(2026-01-30T13:50:06.559Z) | false                   | `new Date()` object. `boolean[]` expected for *array*, but `date` given                                |
...
<small>The file was generated on 30 January 2026 at 13:50:06 (UTC) with the use of *
