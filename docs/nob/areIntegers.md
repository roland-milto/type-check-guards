...
Bruk `areIntegers` til å validere brukeroppgitte eller eksterne data (f.eks. query-parametere, JSON-payloads, CSV-rader)
...
console.log(areIntegers(a)); // sann
console.log(areIntegers(b)); // sann
console.log(areIntegers(c)); // usann
