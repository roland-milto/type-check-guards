...
`false` for tomme matriser og for matriser som inneholder verdier som ikke er indekser.

### Fordeler

- Returnerer `true` bare når inndata er en fylt matrise og hvert element er en gyldig indeks.
- Feiler raskt: returnerer `false` så snart et element som ikke er en indeks blir oppdaget.
...
if (areIndexesFound(a)) {
  // Her blir `a` bekrefta å være en fylt matrise med indekser.
...
<small>Filen ble generert 31 January 2026 at 00:43:03 (UTC) ved bruk av *
