...
>
> `areValidDates` returnerer `false` for et tomt array; sørg for at arrayet er ment å være ikke-tomt før du stoler på
> det som et valideringstrinn.
...
- `array`: Arrayet som skal sjekkes, som potensielt kan inneholde `Date`-objekter.
...
<small>Filen ble generert 30 January 2026 at 14:33:11 (UTC) ved bruk av *
