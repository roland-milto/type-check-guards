...
>
> Bruk `isStream` til å snevre inn `unknown` før du kaller strømmetoder; den gjenkjenner Node.js-strømlignende
...
if (isStream(nodeStream)) {
  // nodeStream er strømlignende; du kan trygt bruke vanlige strøm-API-er
...
<small>Filen ble generert 30 January 2026 at 23:42:20 (UTC) ved bruk av *
