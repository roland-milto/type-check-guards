...
eller at alle numeriske oppføringer er lik en påkrevd konstant), samtidig som tom input behandles som ugyldig (`false`).

> **Merknad for TypeScript-brukere:**
>
> Bruk `areEqual` når du trenger en streng sjekk av alle elementer; den returnerer `false` for tomme arrayer og for
> enhver input som ikke er en array eller ikke er fylt.
...
- Beskytter mot ugyldig input ved å returnere `false` når input ikke er en fylt array.
...
<small>Filen ble generert 31 January 2026 at 23:51:37 (UTC) ved bruk av *
