...
skjemainndata) før du beregner summer, gjennomsnitt eller andre numeriske operasjoner, og sikre at inndata er en
ikke-tom numerisk matrise og ellers returnere `false`.
...
console.log(areNumerics(c)); // usant
console.log(areNumerics(d)); // usant
console.log(areNumerics(e)); // usant
...
<small>Filen ble generert 6 February 2026 at 16:06:39 (UTC) ved bruk av *
