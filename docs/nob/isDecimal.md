...
`isDecimal` sjekker om en verdi er en desimalstrengrepresentasjon uten innledende/etterfølgende mellomrom og med et
...
uten noen omkringliggende mellomrom, før parsing eller lagring.
...
for (const v of inputs) {
  if (isDecimal(v)) {
    // v er en streng her (kjøretidsvalidert)
...
<small>Filen ble generert 31 January 2026 at 15:53:45 (UTC) ved bruk av *
