...
Bruk `areDates` til å validere ukjent inndata (f.eks. tolket JSON, skjemadata, API-payloads) før du kjører
...
console.log(areDates(b)); // usant
console.log(areDates(c)); // usant
...
<small>Filen ble generert 31 January 2026 at 15:31:39 (UTC) ved bruk av *
