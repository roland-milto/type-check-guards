...
Sjekker om alle elementer i en matrise er desimaltall og at matrisen er fylt, og returnerer `true` eller `false`.
...
- Sikrer at inndata er en fylt matrise før elementene valideres, noe som hindrer utilsiktet godkjenning av tomme lister.
...
console.log(areDecimals(b)); // usant
console.log(areDecimals(c)); // usant
```
...
<small>Filen ble generert 31 January 2026 at 15:58:26 (UTC) ved bruk av *
