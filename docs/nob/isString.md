...
>
> Bruk `isString` til å validere `unknown` eller løst typede verdier før du kaller strengmetoder; den returnerer `true`
> kun når `typeof value === "string"`.
...
<small>Filen ble generert 30 January 2026 at 13:15:03 (UTC) ved bruk av *
