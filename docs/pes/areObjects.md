...
- به‌محض اینکه یک عنصرِ غیرشیء پیدا شود، زود متوقف می‌شود و `false` برمی‌گرداند.
- کمک می‌کند ورودیِ ناشناخته را پیش از انجام عملیاتِ مخصوصِ اشیاء اعتبارسنجی کنید.
...
<small>این فایل در 31 January 2026 at 00:10:04 (UTC) با استفاده از *
