...
از `areIntegers` برای اعتبارسنجی داده‌های ارائه‌شده توسط کاربر یا داده‌های خارجی (مثلاً پارامترهای کوئری، payloadهای
JSON، ردیف‌های CSV) استفاده کنید، وقتی منطق شما به یک فهرست پُر از مقادیر عدد صحیح مانند شناسه‌ها، شمارنده‌ها، offsetهای
صفحه‌بندی یا اندیس‌های آرایه نیاز دارد.

> **نکته برای کاربران TypeScript:**
>
> `areIntegers` را به‌عنوان یک گارد زمان اجرا برای ورودی‌های `unknown[]` استفاده کنید، پیش از آن‌که با آن‌ها مانند
...
- کمک می‌کند پیش از انجام عملیات مخصوص اعداد صحیح (مثلاً اندیس‌گذاری، شمارش‌ها، شناسه‌ها) ورودی ناشناخته را اعتبارسنجی
  کنید.
- سریع شکست می‌خورد: به محض پیدا شدن یک عنصر غیرصحیح، بررسی را متوقف می‌کند.
...
<small>این فایل در 31 January 2026 at 01:00:03 (UTC) با استفاده از *
