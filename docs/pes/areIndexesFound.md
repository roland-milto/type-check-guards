...
باشد، قبل از استفاده از آن برای دسترسی به آرایه‌ها یا برش‌زدن آن‌ها.

> **نکته برای کاربران TypeScript:**
>
> از `areIndexesFound` برای اعتبارسنجی ورودی ناشناخته قبل از اینکه عناصرش را به‌عنوان ایندکس‌های آرایه در نظر بگیرید
...
- سریع متوقف می‌شود: به محض برخورد با یک عنصرِ غیرایندکس، `false` برمی‌گرداند.
- به‌عنوان یک گارد قبل از استفاده از مقادیر به‌عنوان موقعیت‌ها یا آفست‌های آرایه مفید است.
...
- `array`: آرایه‌ای که باید از نظر مطابقت با ایندکس بررسی شود.
...
if (areIndexesFound(a)) {
  //‎‎ اینجا، تأیید می‌شود که `a` یک آرایهٔ پُر از اندیس‌ها است.
...
<small>این فایل در 31 January 2026 at 01:03:45 (UTC) با استفاده از *
