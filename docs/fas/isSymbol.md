...
`isSymbol` تعیین می‌کند آیا یک مقدار داده‌شده از نوع `symbol` است یا نه؛ برای symbolها مقدار `true` و در غیر این صورت
`false` برمی‌گرداند.
...
- یک بررسی زمان اجرا ساده و قابل‌اعتماد برای نوع اولیهٔ `symbol` در جاوااسکریپت فراهم می‌کند.
...
<small>این فایل در ۱۰ بهمن ۱۴۰۴ ساعت ۱۴:۲۶:۳۶ (UTC) با استفاده از *
