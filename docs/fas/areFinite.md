...
`areFinite` بررسی می‌کند آیا یک مقدار، آرایه‌ای غیرخالی است که عناصر آن همگی اعداد متناهی هستند یا نه؛ در صورت درست بودن
...
- تنها زمانی `true` برمی‌گرداند که ورودی یک آرایهٔ غیرخالی باشد و هر عنصر آن یک عدد متناهی باشد.
...
<small>این فایل در ۱۰ بهمن ۱۴۰۴ ساعت ۱۶:۳۴:۳۰ (UTC) با استفاده از *
