...
از `isFinite` برای اعتبارسنجی ورودی ناشناخته (مثلاً از JSON، فرم‌ها یا APIها) پیش از انجام محاسبات عددی استفاده کنید تا
...
- یک گزارهٔ ساده و بدون اثر جانبی که برای اعتبارسنجی و منطقِ محافظتی مناسب است.
...
<small>این فایل در ۱۰ بهمن ۱۴۰۴ ساعت ۱۶:۲۹:۴۱ (UTC) با استفاده از *
