...
عملیات ویژهٔ `WeakSet` بررسی کنید که واقعاً یک `WeakSet` است، از `isWeakSet` استفاده کنید.

> **نکته برای کاربران TypeScript:**
>
> از `isWeakSet` برای محدودسازی (narrow) یک مقدار `unknown` به `WeakSet<object>` در زمان اجرا استفاده کنید؛ توجه داشته
> باشید که `WeakSet` فقط می‌تواند ارجاع‌های شیء را در خود نگه دارد.
...
<small>این فایل در ۱۰ بهمن ۱۴۰۴ ساعت ۱۴:۱۴:۳۶ (UTC) با استفاده از *
