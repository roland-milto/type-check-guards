...
sentinel) معنادار است و باید متفاوت از `undefined` یا سایر مقادیر مدیریت شود.

> **نکته برای کاربران TypeScript:**
>
> وقتی لازم است `null` را از `undefined` و سایر مقادیر falsy متمایز کنید از `isNull` استفاده کنید؛ این تابع فقط برای
`null` مقدار `true` برمی‌گرداند.
...
<small>این فایل در ۱۱ بهمن ۱۴۰۴ ساعت ۱۵:۳۹:۰۸ (UTC) با استفاده از *
